...
14:30-15:30 Spatio-temporal cubes, juridicial change

### Tuesday 15/11

09:00-09:45 Spatio-temporal cubes, juridicial change (exercises)

10:00-11:30 External libraries, links to GRASS GIS, landscape metrics, raster/terra

11:30-12:00 Geodemographics

13:00-14:30 Links to GIS, landscape metrics, raster/terra, geodemographics (exercises)

14:45-15:45 Finding systematic patterns in variable/geographic space
...
The local weather forecast may be found at https://www.yr.no/en/forecast/daily-table/1-92388/Norway/Vestland/Bergen/Sandviken. Since working in auditorium M may be a bit constricting, we may break out of the schedule if the sun comes out, and for example walk into town (or part of the way) from mid-afternoon to open up for more informal discussions. For those from outside Bergen, the 7-day public transport ticket is convenient, for example using the Skyss app https://www.skyss.no/en.
...
## Spatio-temporal cubes, juridicial change
